...
#define ESP_SSID "LENOVO_WIFI" // Your network name here
#define ESP_PASS "skumar2k17" // Your network password here

#define HOST     "api.pushingbox.com"     // Host to contact
#define PAGE     "/pushingbox?devid=v25917B61BC0AE92" // Web page to request
